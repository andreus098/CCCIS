...
<center><body class="body1" style="  background:fixed url(./image/bg0.jpg);background-size: 100%;">
<!-- Students -->
	<div class="main">
        <div class="zzz">
            <!-- Students -->
				<?php 
					...
					<?php
						...
						<div class="p_body">';
                            ...
                            <tr>
                            <th>Year Level:</th> <td>'.$uclass_db.'</td>
                            </tr>
                            <tr>
                            <th>Language:</th><td>'.$umedium_db.'</td>
                            </tr>
                            <tr>
                            <th>Time:</th>  <td>'.$usalrange_db.'</td>
                            </tr>
                            <tr>
