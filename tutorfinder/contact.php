...
<body style="  background:fixed url(./image/bg0.jpg);background-size: 100%;">
<div class="body1">
    <div class="container">
        <div class="content">
          <div class="left-side">
            <div class="address details">
              ...
              <br>
              <div class="text-one">Mariano Marcos State University</div>
              <div class="text-two">Brgy. 16 Quiling Sur 2906 Batac City Ilocos Norte</div>
            </div>
            <div class="phone details">
              <i class="fas fa-phone-alt"></i>
              <div class="topic">Phone</div>
              <br>
              <div class="text-one">+639451882814</div>
              <div class="text-two">+639397205904</div>
            </div>
            <div class="email details">
              <i class="fas fa-envelope"></i>
              <div class="topic">Email</div>
              <br>
              <div class="text-one">Andreus Idian</div>
              <div class="text-two">idian22021092@mymail.mmsu.edu.ph</div>
              <br>
              <div class="text-one">Andreus Idian</div>
              <div class="text-two">reusandidian@gmail.com</div>
            </div>
          </div>
